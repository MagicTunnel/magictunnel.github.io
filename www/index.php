    ...
    <div id="content-container">
        ...
        <div id="schema">
            <div id="left-schema">
                ...
                (e.g., <?php echo $_SERVER["SERVER_ADDR"] ?>). Your phone sends DNS queries to a DNS server,
                ...
                <ol>
                    ...
                    <li>
                        ...
                        ForDNS tunneling to work, the network provider must not filter DNS queries to external servers.
                    </li>
